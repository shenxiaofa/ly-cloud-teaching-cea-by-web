;(function (window, undefined) {
    ...
    hiocsApp.service("arrange_courseTimeDemandService", ['$http', '$log', 'app', function($http, $log, app) {
		
		// 删除
		this.empty = function(finalCourseTimeDemand, callback) {
            $http({
                method : 'DELETE',
                params : {
                	'type' : 'deleteBySemesterIdAndCourseId',
                	'semesterId' : finalCourseTimeDemand
                },
