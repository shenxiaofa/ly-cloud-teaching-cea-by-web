;(function (window, undefined) {
	...
	window.arrange_roomScheduleDetailController = function ($scope, $http, $stateParams, $timeout, baseinfo_generalService, alertService, app) {
...
//		// 获取周次的信息并刷新数据，每次点击重新请求数据【参数：当前学年学期    & 所选周次】
	...
	arrange_roomScheduleDetailController.$inject = ['$scope', '$http', '$stateParams', '$timeout', 'baseinfo_generalService', 'alertService', 'app'];
