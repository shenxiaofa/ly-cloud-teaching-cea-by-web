...
;(function (window, undefined) {
    'use strict';
    //考试安排统计Controller
    window.exam_examArrangeCountController = function($scope, baseinfo_generalService, app, $uibModal, $compile, $window, $rootScope, exam_examArrangeCountService, alertService) {
        //学年学期
        ...
        $scope.examArrangeCountTable = {
            ...
            columns: [
                ...
                {field:"teachers",title:"监考教师",align:"center",valign:"middle",
    ...
    exam_examArrangeCountController.$inject = ['$scope', 'baseinfo_generalService', 'app', '$uibModal', '$compile', '$window', '$rootScope', 'exam_examArrangeCountService', 'alertService'];
