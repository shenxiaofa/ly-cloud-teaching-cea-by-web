...
;(function (window, undefined) {
    'use strict';
    //考试时间管理Controller
    window.exam_datetimeManageController = function($scope, $filter, baseinfo_generalService, app, $uibModal, $compile, $window, $rootScope, exam_datetimeManageService, alertService) {
        ...
        $scope.datetimeSet = function(row){
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/finalExamManage/examArrangeManage/examDatetimeManage/datetimeSet.html',
                size: 'lg',
                resolve: {
                    item: function () {
                        return row;
    ...
    exam_datetimeManageController.$inject = ['$scope', '$filter', 'baseinfo_generalService', 'app', '$uibModal', '$compile', '$window', '$rootScope', 'exam_datetimeManageService', 'alertService'];

    //时间指定
    var datetimeSetController = function($scope, $rootScope, app, $filter, alertService, $uibModalInstance, item, exam_datetimeManageService, formVerifyService){
        $scope.examDatetimeManage={};
        ...
        $scope.ok = function (form) {
            ...
            exam_datetimeManageService.update(data,function (error, message) {
    ...
    datetimeSetController.$inject = ['$scope', '$rootScope', 'app', '$filter', 'alertService', '$uibModalInstance', 'item', 'exam_datetimeManageService', 'formVerifyService'];
})(window);
