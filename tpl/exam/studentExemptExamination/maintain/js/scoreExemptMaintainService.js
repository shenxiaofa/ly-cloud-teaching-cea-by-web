...
;(function (window, undefined) {
    ...
    hiocsApp.service("score_exemptMaintainService", ['$http', '$log', 'app', function($http, $log, app) {
        // 添加
        this.add = function(data, callback) {
            $log.debug("add run ...");
            $http.post(app.api.address + '/exam/examReview/addExemptExam',data)
        ...
        this.delete = function(data, callback) {
            ...
            $http.delete(app.api.address + '/exam/examReview/deleteExemptExam/'+data)
                .then(function successCallback(response) {
                    if (response.data.code == app.api.code.success) {
                        callback(false,null,response.data);
                    } else {
