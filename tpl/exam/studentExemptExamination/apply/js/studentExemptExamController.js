...
;(function (window, undefined) {
    'use strict';
    //考试课程维护Controller
    window.score_studentExemptExamController = function($scope, app, $uibModal, $compile, $window, $rootScope, score_studentExemptExamService, alertService) {
        ...
        $scope.createExamClass = function(row){
            ...
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/studentExemptExamination/apply/handle.html',
                size: 'lg',
                resolve: {
                    item: function () {
                        return row;
        ...
        $scope.maintainExamClass = function(row){
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/studentExemptExamination/apply/see.html',
                size: 'lg',
                resolve: {
                    item: function () {
                        return row;
    ...
    score_studentExemptExamController.$inject = ['$scope', 'app', '$uibModal', '$compile', '$window', '$rootScope', 'score_studentExemptExamService', 'alertService'];

    //创建考试班
    var createExamClassController = function($scope, $compile, $timeout, $uibModalInstance, item, score_studentExemptExamService, formVerifyService){
        ...
        $scope.ok = function (form) {
            ...
            score_studentExemptExamService.add($scope.examTeachingTask,$scope.teachingTask);
            $uibModalInstance.close();
        };
    }
    createExamClassController.$inject = ['$scope', '$compile', '$timeout', '$uibModalInstance', 'item', 'score_studentExemptExamService', 'formVerifyService'];

    //维护考试班
    var maintainExamClassController = function($scope, $compile, $timeout, $uibModalInstance, item, score_studentExemptExamService){
        ...
        $scope.ok = function (form) {
            ...
            score_studentExemptExamService.update($scope.teachingTask);
            $uibModalInstance.close();
        };
    }
    maintainExamClassController.$inject = ['$scope', '$compile', '$timeout', '$uibModalInstance', 'item', 'score_studentExemptExamService'];

    //删除考试班
    var deleteExamClassController = function($scope, $uibModalInstance, item, score_studentExemptExamService){
    ...
    deleteExamClassController.$inject = ['$scope', '$uibModalInstance', 'item', 'score_studentExemptExamService'];
})(window);
