...
;(function (window, undefined) {
    'use strict';
    //考试课程维护Controller
    window.score_studentSlowExamController = function($scope, $uibModal, $compile, $window, $rootScope, score_studentSlowExamService, alertService) {
        ...
        $scope.createExamClass = function(row){
            ...
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/studentsSlowExamination/apply/handle.html',
                size: 'lg',
                resolve: {
                    item: function () {
                        return row;
        ...
        $scope.maintainExamClass = function(row){
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/studentsSlowExamination/apply/see.html',
                size: 'lg',
                resolve: {
                    item: function () {
                        return row;
    ...
    score_studentSlowExamController.$inject = ['$scope', '$uibModal', '$compile', '$window', '$rootScope', 'score_studentSlowExamService', 'alertService'];

    //创建考试班
    var createExamClassController = function($scope, $compile, $timeout, $uibModalInstance, item, score_studentSlowExamService, formVerifyService){
        ...
        $scope.ok = function (form) {
            ...
            score_studentSlowExamService.add($scope.examTeachingTask,$scope.teachingTask);
            $uibModalInstance.close();
        };
    }
    createExamClassController.$inject = ['$scope', '$compile', '$timeout', '$uibModalInstance', 'item', 'score_studentSlowExamService', 'formVerifyService'];

    //维护考试班
    var maintainExamClassController = function($scope, $compile, $timeout, $uibModalInstance, item, score_studentSlowExamService){
        ...
        $scope.ok = function (form) {
            ...
            score_studentSlowExamService.update($scope.teachingTask);
            $uibModalInstance.close();
        };
    }
    maintainExamClassController.$inject = ['$scope', '$compile', '$timeout', '$uibModalInstance', 'item', 'score_studentSlowExamService'];

    //删除考试班
    var deleteExamClassController = function($scope, $uibModalInstance, item, score_studentSlowExamService){
    ...
    deleteExamClassController.$inject = ['$scope', '$uibModalInstance', 'item', 'score_studentSlowExamService'];
})(window);
