...
;(function (window, undefined) {
    'use strict';
    //考试课程维护Controller
    window.makeupExam_courseCheckController = function($scope, baseinfo_generalService, $compile, app, $uibModal, $rootScope, $window, exam_courseCheckService, alertService) {
    ...
    makeupExam_courseCheckController.$inject = ['$scope', 'baseinfo_generalService', '$compile', 'app', '$uibModal', '$rootScope', '$window', 'makeupExam_courseCheckService', 'alertService'];
})(window);
