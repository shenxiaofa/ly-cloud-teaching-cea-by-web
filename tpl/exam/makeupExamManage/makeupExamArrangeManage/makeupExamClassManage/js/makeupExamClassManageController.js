...
;(function (window, undefined) {
    'use strict';
    //考试课程维护Controller
    window.makeupExam_classManageController = function($scope, app, baseinfo_generalService, $uibModal, $compile, $window, $rootScope, makeupExam_classManageService, alertService) {
        //学年学期
        ...
        $scope.createExamClass = function(row){
            ...
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/makeupExamManage/makeupExamArrangeManage/makeupExamClassManage/createExamClass.html',
                size: 'lg',
                resolve: {
                    item: function () {
                        return row;
        ...
        $scope.maintainExamClass = function(row){
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/makeupExamManage/makeupExamArrangeManage/makeupExamClassManage/maintainExamClass.html',
                size: 'lg',
                resolve: {
                    item: function () {
                        return row;
        ...
        $scope.deleteExamClass = function(row){
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/makeupExamManage/makeupExamArrangeManage/makeupExamClassManage/deleteExamClass.html',
                resolve: {
                    item: function () {
                        return row;
                    }
    ...
    makeupExam_classManageController.$inject = ['$scope', 'app', 'baseinfo_generalService', '$uibModal', '$compile', '$window', '$rootScope', 'makeupExam_classManageService', 'alertService'];

    //创建考试班
    var createExamClassController = function($scope, $rootScope, alertService, $compile, $timeout, $uibModalInstance, item, makeupExam_classManageService, formVerifyService){
        $scope.info = {};
        ...
        $scope.classInfo = {};
        $scope.classSelected = [];
        makeupExam_classManageService.getTeachingClass(item.id,"",function (error, message,data) {
        ...
        makeupExam_classManageService.getSerialNumber(item.id,function (error, message,data) {
        ...
        $scope.ok = function (form) {
            ...
            makeupExam_classManageService.add(data,function (error, message) {
    ...
    createExamClassController.$inject = ['$scope', '$rootScope', 'alertService', '$compile', '$timeout', '$uibModalInstance', 'item', 'makeupExam_classManageService', 'formVerifyService'];

    //维护考试班
    var maintainExamClassController = function($scope, $rootScope, alertService, $compile, $timeout, $uibModalInstance, item, makeupExam_classManageService){
        $scope.examClass = {};
        ...
        $scope.classInfo = {};
        $scope.classSelected = [];
        makeupExam_classManageService.getTeachingClass(item.formalId,item.id,function (error, message,data) {
            $scope.classInfo.availableOptions = data.data;
        ...
        $scope.ok = function (form) {
            ...
            $rootScope.showLoading = true; // 开启加载提示
            makeupExam_classManageService.maintainExamClass(data,function (error, message) {
                $rootScope.showLoading = false; // 关闭加载提示
                if (error) {
                    alertService(message);
                    return;
    ...
    maintainExamClassController.$inject = ['$scope', '$rootScope', 'alertService', '$compile', '$timeout', '$uibModalInstance', 'item', 'makeupExam_classManageService'];

    //删除考试班
    var deleteExamClassController = function($scope, $rootScope, alertService, $uibModalInstance, item, makeupExam_classManageService){
        ...
        $scope.ok = function () {
            $rootScope.showLoading = true; // 开启加载提示
            makeupExam_classManageService.delete(item.id,function (error, message) {
                $rootScope.showLoading = false; // 关闭加载提示
                if (error) {
                    alertService(message);
                    return;
    ...
    deleteExamClassController.$inject = ['$scope', '$rootScope', 'alertService', '$uibModalInstance', 'item', 'makeupExam_classManageService'];
})(window);
