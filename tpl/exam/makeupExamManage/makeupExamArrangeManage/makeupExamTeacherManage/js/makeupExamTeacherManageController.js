...
;(function (window, undefined) {
    'use strict';
    //监考教师管理Controller
    window.makeupExam_teacherManageController = function($scope, $filter, baseinfo_generalService, app, $uibModal, $compile, $window, $rootScope, makeupExam_teacherManageservice, alertService) {
        //学年学期
        ...
        $scope.teacherSet = function(row){
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/makeupExamManage/makeupExamArrangeManage/makeupExamTeacherManage/teacherSet.html',
                size: 'lg',
                resolve: {
                    item: function () {
                        return row;
    ...
    makeupExam_teacherManageController.$inject = ['$scope', '$filter', 'baseinfo_generalService', 'app', '$uibModal', '$compile', '$window', '$rootScope', 'makeupExam_teacherManageservice', 'alertService'];

    //教师指定
    var finalExamTeacherSetController = function($scope, app, $uibModalInstance, $compile, $uibModal, item, makeupExam_teacherManageservice){
        $scope.classInfo = {};
        ...
        $scope.teacherDelete = function(row){
            ...
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/makeupExamManage/makeupExamArrangeManage/makeupExamTeacherManage/teacherDelete.html',
                size: '',
                resolve: {
                    items: function () {
                        return row;
        ...
        $scope.teacherAdd = function(){
            ...
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/makeupExamManage/makeupExamArrangeManage/makeupExamTeacherManage/teacherAdd.html',
                size: 'lg',
                resolve: {
                    locationId: function () {
    ...
    finalExamTeacherSetController.$inject = ['$scope', 'app', '$uibModalInstance', '$compile', '$uibModal', 'item', 'makeupExam_teacherManageservice'];

    // 删除控制器
    var teacherDeleteController = function ($scope, $rootScope, alertService, $uibModalInstance, items, makeupExam_teacherManageservice) {
        $scope.message = "确定要删除吗？";
        $scope.ok = function () {
            $rootScope.showLoading = true; // 开启加载提示
            makeupExam_teacherManageservice.delete(items.locationTeacherId,function (error, message) {
    ...
    teacherDeleteController.$inject = ['$scope', '$rootScope', 'alertService', '$uibModalInstance', 'items', 'makeupExam_teacherManageservice'];

    var finalExamTeacherAddController = function($scope, $rootScope, baseinfo_generalService, app, locationId, $compile, $uibModalInstance, makeupExam_teacherManageservice, alertService) {
        //性别
        ...
        $scope.ok = function () {
            ...
            $rootScope.showLoading = true; // 开启加载提示
            makeupExam_teacherManageservice.add(data,function (error, message,data) {
                $rootScope.showLoading = false; // 关闭加载提示
                if (error) {
                    alertService(message);
                    return;
    ...
    finalExamTeacherAddController.$inject = ['$scope', '$rootScope', 'baseinfo_generalService', 'app', 'locationId', '$compile', '$uibModalInstance', 'makeupExam_teacherManageservice', 'alertService'];
})(window);
