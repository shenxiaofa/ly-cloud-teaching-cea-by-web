...
;(function (window, undefined) {
    'use strict';
    //考试课程维护Controller
    window.makeupExam_paperNumberManageController = function($scope, $uibModal, $rootScope, $window, makeupExam_paperNumberManageService, alertService) {
        ...
        $scope.numberSet = function(){
            ...
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/exam/makeupExamManage/makeupExamPaperNumberManage/index_numberSet.html',
                size: 'lg',
                resolve: {
                    items: function () {
                        return rows;
    ...
    makeupExam_paperNumberManageController.$inject = ['$scope', '$uibModal', '$rootScope', '$window', 'makeupExam_paperNumberManageService', 'alertService'];

    //编号设置控制器
    var examinationPaperNumberSetController = function ($timeout, $scope, $uibModalInstance, $compile, items, makeupExam_paperNumberManageService, formVerifyService) {
        var numArray = [];
        ...
        $scope.ok = function (form) {
            ...
            makeupExam_paperNumberManageService.update(ids,sjbh);
    ...
    examinationPaperNumberSetController.$inject = ['$timeout', '$scope', '$uibModalInstance', '$compile', 'items', 'makeupExam_paperNumberManageService', 'formVerifyService'];
