...
;(function (window, undefined) {
    ...
    hiocsApp.service("clearExam_listManageService", ['$http', '$log', 'app', function($http, $log, app) {
        // 添加
        this.create = function(data,callback) {
            $log.debug("update run ...");
            $http.post(app.api.address + '/exam/formalArrange/generateCleanExamList',data)
