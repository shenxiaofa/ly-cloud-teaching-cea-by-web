...
;(function (window, undefined) {
    'use strict';
    //考试课程维护Controller
    window.clearExam_courseCheckController = function($scope, baseinfo_generalService, $compile, app, $uibModal, $rootScope, $window, clearExam_courseCheckService, alertService) {
        // 表格的高度
    ...
    clearExam_courseCheckController.$inject = ['$scope', 'baseinfo_generalService', '$compile', 'app', '$uibModal', '$rootScope', '$window', 'clearExam_courseCheckService', 'alertService'];
})(window);
