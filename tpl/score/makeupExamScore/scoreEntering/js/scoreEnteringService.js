;(function (window, undefined) {
    ...
    hiocsApp.service("score_makeupScoreEnteringService", ['$http', '$log', 'app', function($http, $log, app) {
        ...
        this.delete = function(ids, callback) {
            $log.debug("score_makeupScoreEnteringService delete run ...");
            $log.debug(ids);
        ...
        this.update = function(executorId ,teacherInfo, callback) {
            $log.debug("score_makeupScoreEnteringService update run ...");
