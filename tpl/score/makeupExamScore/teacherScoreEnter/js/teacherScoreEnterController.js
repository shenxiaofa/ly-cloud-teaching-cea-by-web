...
;(function (window, undefined) {
    'use strict';
    //考试课程维护Controller
    window.score_makeupTeacherScoreEnterController = function($compile, $scope, $uibModal, $rootScope, $window, makeupExam_listManageService, alertService) {
        ...
        */
        $scope.maintain = function(row){
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/score/makeupExamScore/teacherScoreEnter/enter.html',
                size: 'lg',
                resolve: {
                    item: function () {
                        return row;
        ...
        */
        $scope.adjust = function(row){
            $uibModal.open({
                animation: true,
                backdrop: 'static',
                templateUrl: 'tpl/score/makeupExamScore/teacherScoreEnter/adjust.html',
                size: 'lg',
                resolve: {
                    item: function () {
                        return row;
    ...
    score_makeupTeacherScoreEnterController.$inject = ['$compile', '$scope', '$uibModal', '$rootScope', '$window', 'makeupExam_listManageService', 'alertService'];
